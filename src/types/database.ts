...
export type JobStatus = 'scheduled' | 'in_progress' | 'submitted' | 'approved' | 'rejected' | 'cancelled'
...
export type JobItemResult = Database['public']['Tables']['job_item_results']['Row']
export type JobItemResultInsert = Database['public']['Tables']['job_item_results']['Insert']
export type JobItemResultUpdate = Database['public']['Tables']['job_item_results']['Update']
...
export type JobCommentInsert = Database['public']['Tables']['job_comments']['Insert']
export type JobCommentUpdate = Database['public']['Tables']['job_comments']['Update']

export type ClientShare = Database['public']['Tables']['client_shares']['Row']
export type ClientShareInsert = Database['public']['Tables']['client_shares']['Insert']
export type ClientShareUpdate = Database['public']['Tables']['client_shares']['Update']
